...
<div class="row mb-2">
    <div class="card">
        <div class="card-header  bg-white">
            <h3 class="card-title">
               @lang('site.add')    @lang('site.websitelink')
            </h3>
        </div>
        <div class="card-body p-1">
            <form action="{{ route('admin.websitelinks.store') }}" method="post">
                @csrf
                @method('post')
                <div class="row m-2 col-md-12">
                    ...
                    <div class="form-group col-md-6 p-0 m-0 px-2">
                        ...
                        <input type="url" name="site_url" class="form-control @error('sitle_url') is-invalid @enderror" placeholder="@lang('site.site_url')"
                            id="site_url" value="{{ old('site_url') }}">
