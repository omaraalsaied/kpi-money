...
@section('title',' | ' . __('site.add') .' - '. __('site.adsSettings'))
@section('content')
<div class="row mb-2">
    <div class="card">
        <div class="card-header  bg-white">
            <h3 class="card-title">
                @lang('site.add')   @lang('site.adsSettings')
            </h3>
        </div>
        <div class="card-body p-1">
            <form action="{{ route('admin.adssettings.store') }}" method="post">
                @csrf
                @method('post')
                <div class="row m-2">
                    <div class=" col-md-6">
                        ...
                        <div class="form-group p-0 m-0 px-2">
                            ...
                            <input type="text" name="admob_app_id" class="form-control  @error('admob_app_id') is-invalid @enderror" placeholder="@lang('site.admob_app_id')"
                                id="admob_app_id" value="{{ old('admob_app_id')}}">
                                @error('admob_app_id')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                        </div>
                    ...
                    <div class="form-group p-0 m-0 px-2">
                        ...
                        <input type="text" name="facebook_rads_p_id" class="form-control  @error('facebook_rads_p_id') is-invalid @enderror" placeholder="@lang('site.facebook_rads_p_id')"
                            id="facebook_rads_p_id" value="{{ old('facebook_rads_p_id')}}">
